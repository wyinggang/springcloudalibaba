...
//    private final static Logger logger = LoggerFactory.getLogger(FallBackAspect.class);
//
//    @Before("execution(* com.wyg.springcloudalibaba.service.*.create(..))")
...
//    }
//
//    @AfterThrowing(throwing = "e", pointcut = "execution(* com.wyg.springcloudalibaba.service.*.create(..))")
...
//    }
//
////    @AfterReturning(value = "execution(* com.wyg.springcloudalibaba.service.*.create(..))", returning = "result")
